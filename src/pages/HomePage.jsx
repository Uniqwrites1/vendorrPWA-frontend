          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-2xl mx-auto mt-8">
              {stats.map((stat, index) => (
                <div key={index} className="text-center bg-vendorr-blue-600/90 backdrop-blur-md rounded-lg py-6 px-4 border-2 border-vendorr-gold-400 shadow-lg hover:bg-vendorr-blue-600 hover:shadow-xl transition-all hover:scale-105">
